...
void error_usage()
{
    ...
    fprintf(stderr, "  -tp <string> tokenizer filename (default = gpt2_tokenizer.bin)\n");
...
int main(int argc, char *argv[])
{
    ...
    const char *tokenizer_filename = "gpt2_tokenizer.bin";
    ...
    for (int i = 1; i < argc; i += 2)
    {
        ...
        else if (argv[i][1] == 't' && argv[i][2] == 'p')
        {
            tokenizer_filename = argv[i + 1];
        }
        else if (argv[i][1] == 'e')
        {
